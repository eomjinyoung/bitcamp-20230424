...
import bitcamp.myapp.service.RestService;
...
public class AuthController {
  ...
  private final RestService.FacebookService facebookService;
  private final RestService.JwtService jwtService;
...
//    );
    ...
    Map<String,Object> result = facebookService.me(facebookAccessToken, "id,name,email,gender");
...
//    );
    ...
    return RestResult.builder()
            ...
            .data(jwtService.token(
                    "Basic " + HttpHeaders.encodeBasicAuth(user.getEmail(), DEFAULT_PASSWORD, null)))
            .build();
  }
}
